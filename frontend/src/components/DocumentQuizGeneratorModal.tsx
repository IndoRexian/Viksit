...
> = ({ isOpen, onClose, availableCompetencies = [] }) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-white border border-slate-300 rounded-xl shadow-2xl max-w-3xl w-full my-6 overflow-hidden flex flex-col relative max-h-[92vh] ${
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 bg-slate-50/50">
          {error && (
            <div className="mb-5 p-3.5 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3 text-xs text-red-800 animate-fadeIn">
          ...
          {!quizData && !generating && (
            <div key="setup-view" className="space-y-6 animate-fade-in">
              ...
              <div>
                ...
                <div className="mt-3 p-3 bg-white border border-slate-200 rounded-lg flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 shadow-2xs">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {SAMPLE_DOCS.map((sample) => (
                      <button
                        ...
                        className="px-2.5 py-1 bg-slate-50 hover:bg-slate-100 border border-slate-300 hover:border-slate-400 text-slate-800 text-[11px] font-semibold rounded cursor-pointer transition-colors inline-flex items-center gap-1 shadow-2xs"
                        title={sample.title}
                      >
              ...
              {availableCompetencies.length > 0 && (
                <div className="p-4 bg-white border border-slate-200 rounded-lg shadow-2xs">
                  ...
                  <select
                    ...
                    className="w-full text-xs bg-slate-50 border border-slate-300 rounded-lg px-3 py-2 text-slate-800 focus:outline-hidden focus:ring-1 focus:ring-blue-900 cursor-pointer"
                  >
                    <option value="all">
          ...
          {quizData && (
            <div key="player-view" className="space-y-5 animate-fade-in">
              {isEvaluating ? (
                ...
                <div className="py-20 flex flex-col items-center justify-center text-center space-y-6 animate-fade-in bg-white rounded-xl border border-slate-200 shadow-2xs p-8">
                  <div className="relative">
                ...
                <div className="space-y-5">
                  <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-2xs">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={handleReset}
                          className="px-2.5 py-1 text-xs text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 rounded border border-slate-300 font-medium cursor-pointer transition-colors"
                  ...
                  <div className="flex items-center gap-1.5 overflow-x-auto pb-1">
                    {questions.map((_, idx) => {
                      ...
                      let btnColor = "bg-white text-slate-700 border-slate-200";
                      if (isCurrent) {
                        btnColor =
                  ...
                  {currentQuestion && (
                    <div
                      key={currentIdx}
                      className="bg-white border border-slate-200 rounded-xl p-5 sm:p-6 shadow-2xs space-y-5 animate-fade-in"
                    >
                      <div className="flex flex-wrap items-center gap-2">
                        <span
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                        <button
                          ...
                          className="px-3 py-1.5 border border-slate-300 rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-1 cursor-pointer"
                        >
                        ...
                        {currentIdx < totalQuestions - 1 ? (
                          ...
                          <button
                            ...
                            className="px-5 py-2 bg-emerald-700 text-white rounded-lg text-xs font-bold hover:bg-emerald-800 flex items-center gap-1.5 shadow-xs cursor-pointer"
                          >
                ...
                <div className="space-y-5 animate-fade-in">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <h4 className="font-serif text-base sm:text-lg font-bold text-slate-900 mt-0.5">
                            {scorePct >= 80
                      ...
                      <div className="flex items-baseline gap-2 bg-slate-50 border border-slate-200 px-4 py-2 rounded-lg">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 bg-white border border-slate-200 p-3 rounded-lg shadow-2xs">
                    ...
                    {questions
                      ...
                      .map(({ q, originalIdx }) => {
                        ...
                        return (
                          <div
                            key={originalIdx}
                            className={`bg-white border rounded-xl p-4 sm:p-5 shadow-2xs space-y-3 transition-all ${
                              isCorrect
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2.5 pt-3 border-t border-slate-200 bg-white p-3.5 rounded-lg border">
                    <button
                      type="button"
                      onClick={handleExportJson}
                      className="px-3.5 py-1.5 border border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold text-xs rounded-lg inline-flex items-center gap-1.5 cursor-pointer transition-colors"
                    >
                      <Download size={13} />
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-3.5 py-1.5 bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-800 font-semibold text-xs rounded-lg inline-flex items-center gap-1.5 cursor-pointer transition-colors"
                      >
                        <RotateCw size={13} />
